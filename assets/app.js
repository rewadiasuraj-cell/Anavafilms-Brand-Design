...
function contact(){return `<section class="contact-hero"><div class="contact-hero-pill-wrap"><span class="contact-pill">START A CONVERSATION</span></div><h1 class="reveal">Got a <em class="accent-text">Thought?</em></h1><p class="reveal">You don’t need a finished brief. You don’t need a script. You don’t even need to know exactly what the film should look like. Just give us the thought. We’ll bring the ideas.</p></section><section class="contact-cards-section"><div class="contact-grid"><div class="contact-card direct-contact-card reveal"><span class="eyebrow">DIRECT CONTACT</span><h2>LET’S TALK</h2><p class="contact-card-sub">Whether you have an upcoming product campaign, a single-line thought, or need creative consulting, our team in Mumbai and Delhi is ready.</p><div class="contact-divider"></div><div class="contact-info-group"><span class="info-label">EMAIL US</span><a class="contact-link" href="mailto:office@anavafilms.com"><img src="assets/icons/email.svg" width="18" height="18" alt="" loading="lazy"><span>office@anavafilms.com</span></a></div><div class="contact-info-group"><span class="info-label">DIRECT PHONE NUMBERS</span><a class="contact-link" href="tel:+918691924669"><img src="assets/icons/phone.svg" width="18" height="18" alt="" loading="lazy"><span>Jackson: +91 86919 24669</span></a><a class="contact-link" href="tel:+919911111273"><img src="assets/icons/phone.svg" width="18" height="18" alt="" loading="lazy"><span>Anjan: +91 99111 11273</span></a></div><div class="contact-info-group"><span class="info-label">LOCATIONS</span><p class="location-text">Mumbai · Delhi</p></div><div class="contact-info-group"><span class="info-label">CONNECT DIRECTLY</span><div class="social-pills"><a class="social-pill-btn" href="https://www.instagram.com/anava_films" target="_blank" rel="noopener"><img src="assets/icons/instagram.png" width="15" height="15" alt="" loading="lazy"><span>INSTAGRAM</span></a><a class="social-pill-btn" href="https://vimeo.com/zackdirect" target="_blank" rel="noopener"><img src="assets/icons/vimeo.png" width="15" height="15" alt="" loading="lazy"><span>VIMEO</span></a><a class="social-pill-btn" href="https://www.youtube.com/@anava-films" target="_blank" rel="noopener"><img src="assets/icons/youtube.png" width="15" height="15" alt="" loading="lazy"><span>YOUTUBE</span></a></div></div></div><div class="contact-card form-card reveal"><h2>SEND US YOUR THOUGHT</h2><form id="enquiry"><label><span class="field-label">YOUR NAME / BRAND</span><input name="name" autocomplete="name" required placeholder="e.g. Rahul / Brand Name"></label><label><span class="field-label">EMAIL ADDRESS</span><input name="email" type="email" autocomplete="email" required placeholder="name@company.com"></label><label><span class="field-label">WHAT KIND OF FILM OR CONTENT ARE YOU THINKING OF?</span><select name="project_type" class="contact-select" required><option value="" disabled selected>Select content type...</option><option value="Commercial TVC / Brand Film">Commercial TVC / Brand Film</option><option value="Vertical / Social Film">Vertical / Social Film</option><option value="Event Film">Event Film</option><option value="Testimonial">Testimonial</option><option value="Photoshoot">Photoshoot</option><option value="Not sure yet">Not sure yet</option></select></label><label><span class="field-label">TELL US YOUR THOUGHT</span><textarea name="message" required placeholder="Even if it's just one thought, problem or product objective..."></textarea></label><button class="contact-submit-btn" type="submit"><span>LET’S MAKE IT.</span> ${arrow}</button><p class="form-status" role="status"></p></form></div></div></section>`}
